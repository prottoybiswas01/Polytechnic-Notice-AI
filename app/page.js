...
export default function Home() {
  ...
  const sampleQuestions = [
    "পলিটেকনিকে ভর্তির আবেদনের প্রধান ধাপ ও নিয়মগুলো কী কী?",
    "পলিটেকনিকে ভর্তির জন্য ন্যূনতম কী জিপিএ যোগ্যতা লাগে?",
    "ভর্তির চয়েস লিস্ট কীভাবে সাজালে চান্স পাওয়ার সম্ভাবনা বাড়ে?",
    "ভোকেশনাল ও মহিলা কোটায় ভর্তির সুযোগ ও সুবিধা কী কী?",
  ];
